"""
 ...
 @description
 `gpt3_single_image()` sends a single [image creation request](https://beta.openai.com/docs/api-reference/images/create-edit) to the Open AI GPT-3 API.
...
gpt3_single_image(;prompt_input="",
n = 1,
size = "256x256", # "512x512", "1024x1024"
response_format = "url", # "b64_json"
output_type = "complete"
